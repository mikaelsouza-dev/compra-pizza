...
let updateCart = () => {
    ...
    if (cart.length > 0) {
        ...
        qs('.subtotal span:last-child').innerText = `R$ ${subtotal.toFixed(2)}`;
        qs('.desconto span:last-child').innerText = `R$ ${desconto.toFixed(2)}`;
        qs('.total span:last-child').innerText = `R$ ${total.toFixed(2)}`;
